...
class QuotesControllerTest {
    ...
    void returnsNotFoundOnUnsupportedSymbol() {
        try {
            client.toBlocking().exchange(GET("/quotes/UNSUPPORTED"), Argument.of(Quote.class), Argument.of(CustomError.class));
