...
@Testcontainers
public class ExternalQuoteProducerTest {

    private static final Logger LOG = LoggerFactory.getLogger(ExternalQuoteProducerTest.class);
    private static final String PROPERTY_NAME = "ExternalQuoteProducerTest";
    ...
    void producing10RecordsWorks() {
        ...
        // observer needs to wait for seconds
