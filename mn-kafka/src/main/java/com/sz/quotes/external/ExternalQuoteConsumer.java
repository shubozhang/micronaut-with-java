...
import com.sz.prices.PriceUpdate;
import com.sz.prices.PriceUpdateProducer;
...
public class ExternalQuoteConsumer {
    ...
    void receive(List<ExternalQuote> externalQuotes) {
        ...
        final List<PriceUpdate> priceUpdates = externalQuotes
                .stream()
        ...
        priceUpdateProducer
                ...
                .forEach(recordMetadata -> { LOG.debug("Record sent to topic {} on offset {}", recordMetadata.topic(), recordMetadata.offset()); });
    }
}
